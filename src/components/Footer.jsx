  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-14 md:py-16">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-5 gap-8 md:gap-10">
          ...
          <div>
            <h4 className="text-xs sm:text-sm font-bold text-white mb-3 sm:mb-5 uppercase tracking-wider">
              Product
            </h4>
              ...
              {[
                ...
                return (
                  <a
                    ...
                    href="#"
                    aria-label={label}
                    className="w-9 h-9 sm:w-10 sm:h-10 bg-gray-800 hover:bg-purple-600 rounded-full flex items-center justify-center transition-colors duration-200"
                  >
                    <Icon />
                  </a>
                );
